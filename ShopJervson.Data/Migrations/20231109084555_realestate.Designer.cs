...
namespace ShopJervson.Data.Migrations
{
    ...
    [Migration("20231109084555_realestate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopJervson.Core.Domain.FileToApi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShopJervson.Core.Domain.FileToDatabase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopJervson.Core.Domain.RealEstate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopJervson.Core.Domain.Spaceship", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShopJervson.Core.Domain.FileToApi", b =>
                {
                    b.HasOne("ShopJervson.Core.Domain.RealEstate", null)
                        .WithMany("FilesToApi")
